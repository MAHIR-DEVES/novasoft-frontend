...
import ServiceComparison from '@/components/common/home/ServiceComparison';
...
export default function Page() {
  return (
    <div
      ...
      className=" bg-gradient-to-b from-gray-50 to-white dark:bg-[#0F0B1A] transition-colors duration-300"
    >
      <Banner></Banner>
...
// bg-gradient-to-b from-white to-[#f8f6ff]
